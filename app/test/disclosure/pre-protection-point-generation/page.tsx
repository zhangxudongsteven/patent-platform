...
export default function PreProtectionPointGenerationPage() {
  ...
  const { completion, complete, isLoading, stop, setCompletion } =
    useCompletion({
      api: "/api/disclosure/pre-protection-point-generation",
      streamProtocol: "text",
      onFinish: () => {
        toast.success("生成完成", {
          description: "预保护点已成功生成",
        });
      },
      onError: (error: Error) => {
        console.error(error);
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4 pt-0 max-w-6xl mx-auto w-full h-[calc(100vh-6rem)]">
      <div className="flex items-center justify-between space-y-2 mb-2">
        <h2 className="text-3xl font-bold tracking-tight">“预保护点”生成</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
        ...
        <Card className="flex flex-col h-full">
          <CardHeader>
            ...
            <CardDescription>
              提供技术背景和技术方案，AI 将为您生成专业的技术关键点和预保护点。
            </CardDescription>
          </CardHeader>
