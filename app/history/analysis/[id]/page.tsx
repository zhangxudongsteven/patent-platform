...
export default function AnalysisHistoryPage() {
  ...
  const loadHistory = async () => {
    try {
      ...
      if (data.success && data.data) {
        ...
        if (historyRecord.operation_type === "analysis") {
    ...
    return (
      <div className="flex flex-col h-full">
        <header className="flex items-center gap-2 border-b px-4 py-3">
          ...
          <span className="font-semibold">专利解析</span>
        </header>
  ...
  return (
    <div className="flex-1 flex-col">
      <AnalysisProvider initialFileNames={initialData?.fileNames || []} initialData={initialData} chatId={chatId}>
        <AnalysisWorkflow
          fileNames={initialData?.fileNames || []}
